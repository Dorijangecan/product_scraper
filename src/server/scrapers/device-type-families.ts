...
export const DEVICE_TYPE_FAMILIES: Record<string, readonly FamilyEntry[]> = {
  abb: [
    ...
    { patterns: ["CR-U", "CR-M"], type: "Relay", notes: "CR-U / CR-M interface and time relays" },
    { patterns: ["MEP", "MEPY"], type: "Enclosure", notes: "MEP emergency-stop enclosures" },
    { patterns: ["MDB"], type: "Accessory", notes: "MDB dummy blocks and operator accessories" },
    { patterns: ["JSHD"], type: "Switch", notes: "JSHD three-position handheld devices" },
    { patterns: ["LineStrong"], type: "Safety Sensor", notes: "LineStrong pull-wire safety switches" },
    { patterns: ["M2SS"], type: "Selector Switch", notes: "M2SS selector switches" },
    { patterns: ["ML1"], type: "Pilot Light", notes: "ML1 pilot lights" },
    { patterns: ["CB1"], type: "Stack Light / Beacon", notes: "CB1 buzzers and signal devices" },
    { patterns: ["1SVR405"], type: "Relay", notes: "CR-U / CR-M relay modules" },
