...
export const DEVICE_TYPE_URL_PATTERNS: UrlPatternEntry[] = [
  ...
  { host: /rockwellautomation\.com$/i, pattern: /\/programmable[-\s]?controllers?|\/compactlogix|\/controllogix|\/micro800|\/micro820/i, type: "Programmable Logic Controller" },
  { host: /rockwellautomation\.com$/i, pattern: /\/(?:i-o|io|input-output|distributed[-\s]?i-o|point[-\s]?i-o|flex[-\s]?5000|compact[-\s]?5000[-\s]?i-o)/i, type: "I/O Module" },
  { host: /rockwellautomation\.com$/i, pattern: /\/(?:industrial[-\s]?ethernet|stratix|networking|communication[-\s]?(?:module|adapter|gateway))/i, type: "Communication Gateway" },
  { host: /rockwellautomation\.com$/i, pattern: /\/(?:powerflex|kinetix|servo[-\s]?drive|ac[-\s]?drive|variable[-\s]?frequency)/i, type: "Variable Speed Drive" },
  { host: /rockwellautomation\.com$/i, pattern: /\/(?:power[-\s]?supplies|switched[-\s]?mode[-\s]?power[-\s]?supply|1606)/i, type: "Power Supply" },
  { host: /rockwellautomation\.com$/i, pattern: /\/(?:panelview|hmi|operator[-\s]?terminal)/i, type: "HMI" },
  { host: /rockwellautomation\.com$/i, pattern: /\/(?:safety[-\s]?relay|guardmaster|safety[-\s]?controller)/i, type: "Safety Relay" },
  { host: /rockwellautomation\.com$/i, pattern: /\/(?:safety[-\s]?(?:sensor|switch|light[-\s]?curtain|interlock)|guard[-\s]?locking)/i, type: "Safety Sensor" },
  { host: /rockwellautomation\.com$/i, pattern: /\/(?:photoelectric|photoswitch|42[a-z0-9-]*)/i, type: "Photoelectric Sensor" },
  { host: /rockwellautomation\.com$/i, pattern: /\/(?:inductive[-\s]?proximity|proximity[-\s]?sensor|87[125])/i, type: "Inductive Proximity Sensor" },
  { host: /rockwellautomation\.com$/i, pattern: /\/(?:pressure[-\s]?sensor|836p)/i, type: "Pressure Sensor" },
  { host: /rockwellautomation\.com$/i, pattern: /\/(?:temperature[-\s]?sensor|837t)/i, type: "Temperature Sensor" },
  { host: /rockwellautomation\.com$/i, pattern: /\/(?:flow[-\s]?sensor|839e)/i, type: "Flow Sensor" },
  { host: /rockwellautomation\.com$/i, pattern: /\/(?:level[-\s]?sensor|840e)/i, type: "Level Sensor" },
  { host: /rockwellautomation\.com$/i, pattern: /\/(?:iec[-\s]?contactors?|100[-\s]?c|100[-\s]?k)/i, type: "Contactor" },
  { host: /rockwellautomation\.com$/i, pattern: /\/(?:motor[-\s]?protection|manual[-\s]?motor[-\s]?starter|140m)/i, type: "Motor Circuit Breaker" },
  { host: /rockwellautomation\.com$/i, pattern: /\/(?:molded[-\s]?case|140g)/i, type: "Circuit Breaker" },
  { host: /rockwellautomation\.com$/i, pattern: /\/(?:miniature[-\s]?circuit[-\s]?breaker|supplementary[-\s]?protector|1489|1492[-\s]?sp)/i, type: "Miniature Circuit Breaker" },
  { host: /rockwellautomation\.com$/i, pattern: /\/(?:disconnect[-\s]?switch|194r|194e|194l)/i, type: "Disconnect Switch" },
  { host: /rockwellautomation\.com$/i, pattern: /\/(?:push[-\s]?buttons?|operator[-\s]?interface|800f|800t|800h)/i, type: "Pushbutton / Operator" },
  { host: /rockwellautomation\.com$/i, pattern: /\/(?:stack[-\s]?lights?|signal[-\s]?tower|beacon|855|856|852)/i, type: "Stack Light / Beacon" },
  { host: /rockwellautomation\.com$/i, pattern: /\/(?:terminal[-\s]?blocks?|1492)/i, type: "Terminal Block" },
