...
export const GLOBAL_TECHNICAL_ATTRIBUTE_ALIASES: TechnicalAttributeAlias[] = [
  ...
  globalAlias("ratedVoltage", "Module supply voltage"),
  globalAlias("ratedVoltage", "Sensor supply voltage"),
  globalAlias("ratedVoltage", "Auxiliary voltage"),
  globalAlias("ratedVoltage", "Load voltage"),
  globalAlias("ratedVoltage", "Voltage range"),
  ...
  globalAlias("ratedCurrent", "Load current"),
  globalAlias("ratedCurrent", "Nominal load current"),
  globalAlias("ratedCurrent", "Maximum load current"),
  globalAlias("ratedCurrent", "Output current rating"),
  globalAlias("ratedCurrent", "Output current range"),
  globalAlias("ratedCurrent", "Current-carrying capacity"),
  globalAlias("ratedCurrent", "Permissible current"),
  ...
  globalAlias("powerLoss", "Module power dissipation"),
  globalAlias("powerLoss", "Dissipation power"),
  globalAlias("powerLoss", "Dissipated power"),
  globalAlias("powerLoss", "Power dissipated"),
  ...
  globalAlias("currentConsumption", "Current consumption"),
  globalAlias("currentConsumption", "Current consumption max."),
  globalAlias("currentConsumption", "Input current"),
  globalAlias("currentConsumption", "Input current max."),
  globalAlias("currentConsumption", "Supply current"),
  globalAlias("currentConsumption", "Module current draw"),
  globalAlias("currentConsumption", "Current draw"),
  globalAlias("currentConsumption", "Current draw at 24V DC"),
  globalAlias("currentConsumption", "Current draw @ 24V DC"),
  globalAlias("currentConsumption", "No-load current Io max."),
  globalAlias("currentConsumption", "Quiescent current"),
  globalAlias("currentConsumption", "Standby current"),
  globalAlias("currentConsumption", "Stromaufnahme"),
...
export const MANUFACTURER_TECHNICAL_ATTRIBUTE_ALIASES: TechnicalAttributeAlias[] = [
  ...
  alias("rockwell", "Rockwell Automation", "currentConsumption", "Current Draw", ROCKWELL_IO, "Rockwell I/O technical data"),
  alias("rockwell", "Rockwell Automation", "currentConsumption", "Current Draw at 24V DC", ROCKWELL_IO, "Rockwell I/O technical data"),
  alias("rockwell", "Rockwell Automation", "currentConsumption", "Current Draw @ 24V DC", ROCKWELL_IO, "Rockwell I/O technical data"),
